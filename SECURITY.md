...
Security policy of [`medea-turn`] crate.
...
Before going `1.0`, the [`medea-turn`] crate maintains only the most recent minor release. 
...
Security is of the highest importance and all security vulnerabilities or suspected security vulnerabilities should be reported to this project privately, to minimize attacks against current users of [`medea-turn`] crate before they are fixed. Vulnerabilities will be investigated and patched on the next patch (or minor) release as soon as possible. This information could be kept entirely internal to the project.
...
[`medea-turn`]: https://docs.rs/medea-turn
